...
import 'package:movies_app/feature/search/presentation/views/widgets/search_for_movie_text.dart';
import 'package:movies_app/feature/search/presentation/views/widgets/search_result_item.dart';
import 'package:movies_app/feature/search/presentation/views/widgets/shimmer_search_result_grid_view.dart';
    ...
    return BlocBuilder<SearchCubit, SearchState>(
      builder: (context, state) {
        if (state is SearchMovieLoading) {
          return ShimmerSearchResultGridView();
